...
export function ChatInterface() {
  ...
  useCopilotAction({
    name: "deliver_report",
    available: "frontend",
    description: "Displays a narrative PDF report generated by the report_builder agent.",
    parameters: [
      { name: "temp_id", type: "string", description: "Temp store ID for the PDF" },
      { name: "title", type: "string", description: "Report title" },
      { name: "markdown_content", type: "string", description: "Source markdown" },
    ],
    render: ({
      status,
      args,
      ...
      [
        { name: "temp_id"; type: "string"; description: string },
        { name: "title"; type: "string"; description: string },
        { name: "markdown_content"; type: "string"; description: string },
      ]
    >): React.ReactElement => (
      <ReportBuilderCard
        status={status}
        temp_id={typeof args.temp_id === "string" ? args.temp_id : ""}
        title={typeof args.title === "string" ? args.title : ""}
        markdown_content={typeof args.markdown_content === "string" ? args.markdown_content : ""}
      />
    ),
  });
