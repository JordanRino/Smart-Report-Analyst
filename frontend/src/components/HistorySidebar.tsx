  ...
  return (
    <div className="w-72 bg-zinc-900 text-zinc-300 h-screen flex flex-col border-r border-zinc-800">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-1">
        <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-4">Past conversations</h3>
        ...
        {loading ? (
          ...
          <p className="text-xs text-zinc-600 text-center py-4 italic">No past conversations yet.</p>
        ) : (
          threads.map((t) => (
            <button
              key={t.id}
